...
const FEATURED_COMPANIES = [
  {
    ...
    description: 'Transferred its own equity to a trust dedicated to fighting climate change. Still runs like a gear company.',
    bcorp: true,
  },
  {
    ...
    hq: 'Burlington, VT',
    ownershipStatus: 'Private - Family Owned',
    description: 'Jake Burton invented the snowboard industry. His family still owns the company.',
    bcorp: true,
  },
  {
    name: 'Arc\'teryx',
    ...
    description: 'Started as a climbing harness company in North Vancouver. Now a $475M piece of a Chinese sports conglomerate.',
    bcorp: false,
  },
  {
    name: 'Trek Bicycle',
    ...
    hq: 'Waterloo, WI',
    ownershipStatus: 'Private - family owned',
    description: 'Over a billion in revenue. Still family-owned in Waterloo, Wisconsin.',
    bcorp: false,
  },
];
...
const STATS = [
  { value: '200+', label: 'Brands in the directory' },
  { value: '~66%', label: 'Still independently owned' },
  { value: '22', label: 'Corporate ownership groups mapped' },
];
        ...
        <Container maxWidth="xl" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ maxWidth: 720 }}>
            ...
            >
              ...
              The outdoor industry's ownership record
            </Typography>
            ...
            >
              The outdoor world is full of independent builders.
            </Typography>
            ...
            >
              We track who owns what — so you can find the brands still run by the people who built them, and understand the full picture of the industry behind your gear.
            </Typography>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 6, alignItems: 'center' }}>
            <Box>
              ...
              <Typography variant="h2" sx={{ fontSize: { xs: '2rem', md: '2.75rem' }, color: '#FFFFFF', mb: 3 }}>
                One map, every connection
              </Typography>
              <Typography sx={{ color: 'rgba(255,255,255,0.65)', fontSize: '1.0625rem', lineHeight: 1.7, mb: 4, maxWidth: 440 }}>
                Arc'teryx, Salomon, and Peak Performance — one owner. The North Face, Smartwool, Icebreaker — another. An interactive graph of every parent company and subsidiary we track.
              </Typography>
              <Box
                component={Link}
                to="/ownership-map"
        ...
        <Container maxWidth="md">
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography sx={{ color: colors.textSecondary, fontSize: '1.0625rem', mb: 4, maxWidth: 480, mx: 'auto', lineHeight: 1.6 }}>
              New profiles, acquisition news, and notes on the business of the outdoors.
            </Typography>
            <Box
              component="form"
